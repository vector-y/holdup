        ...
        <section className="bg-white">
            <div className="py-8 px-4 mx-auto text-left max-w-screen-xl lg:px-12">
                ...
                <div className="flex flex-col mt-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                    <a href="https://apps.apple.com/us/app/holdup-share-climbing-beta/id6450128614" className="inline-flex justify-center items-center py-4 px-10 text-base hover:text-white font-medium text-center text-black rounded-full bg-green-500 hover:bg-green-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        <p className="font-bold text-x">Join now</p>
